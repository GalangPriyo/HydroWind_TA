...
// Menu Sidebar
const menuItems = ref([
    { name: "Dashboard", link: "/admin/dashboard", icon: "fa-house" },
    { name: "Daftar Pengguna", link: "/admin/users", icon: "fa-users" },
    { name: "Daftar Alat", link: "/admin/devices", icon: "fa-toolbox" },
